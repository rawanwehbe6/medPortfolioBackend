...
CREATE TABLE `supervisors` (
  ...
  `AssignedTrainees` json DEFAULT NULL,
  `ProfilePicture` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Supervisor_ID`),
  UNIQUE KEY `User_ID` (`User_ID`),
  CONSTRAINT `supervisors_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `users` (`User_ID`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2026001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
