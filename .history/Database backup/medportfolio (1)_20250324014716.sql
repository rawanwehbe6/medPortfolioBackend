...
CREATE TABLE journal_club_assessment (
    ...
    paper_selection ENUM('Below Expectations', 'Meets Expectations', 'Exceeds Expectations', 'U/A') NOT NULL,
    background_knowledge ENUM('Below Expectations', 'Meets Expectations', 'Exceeds Expectations', 'U/A') NOT NULL,
    critical_analysis_methodology ENUM('Below Expectations', 'Meets Expectations', 'Exceeds Expectations', 'U/A') NOT NULL,
    critical_analysis_results ENUM('Below Expectations', 'Meets Expectations', 'Exceeds Expectations', 'U/A') NOT NULL,
    conclusions_drawn ENUM('Below Expectations', 'Meets Expectations', 'Exceeds Expectations', 'U/A') NOT NULL,
    ...
    evaluator_id INT NOT NULL,
    FOREIGN KEY (evaluator_id) REFERENCES users(User_ID) ON DELETE CASCADE ON UPDATE CASCADE
