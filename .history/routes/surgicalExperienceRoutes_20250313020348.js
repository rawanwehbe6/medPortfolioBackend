...
const { updateSurgicalExperience, deleteSurgicalExperience, getAllSurgicalExperiences } = require('../controllers/surgicalExperienceController');
const { checkTraineeRole } = require('../middleware/authMiddleware');

// Route for creating a new surgical experience
// router.post('/', checkTraineeRole, createSurgicalExperience);
